	...
	class ModelClass{
		...
		function do_query($myquery){
			if($this->connectionType=='mysqli'){
				$data_result=mysqli_query($this->connection,SecurityClass::dbEscape($myquery,$this->connectionType));
				...
				if(($data_result=sqlsrv_query($this->connection,SecurityClass::dbEscape($myquery,$this->connectionType)))===false){
